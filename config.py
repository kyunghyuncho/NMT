...
def get_config_fide_en_condAll_05_scratch():
    config = {}
    ...
    config['representation_dim'] = 2000  # this is the joint annotation
                                         # dimension of encoders
    config['saveto'] = 'multiEnc_FIDE_condAll_05_scratch'
...
def get_config_fide_en_condAll_05_reloadGH():
    config = {}
    ...
    config['representation_dim'] = 2000  # this is the joint annotation
                                         # dimension of encoders
    config['saveto'] = 'multiEnc_FIDE_condAll_05_reloadGH'
